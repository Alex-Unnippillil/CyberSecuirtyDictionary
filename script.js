...
// --- Message classifier and chip rendering ---
...
function classifyMessage(text) {
  const mapping = [
    { category: "search", keywords: ["search", "find", "look up"] },
    { category: "navigate", keywords: ["go to", "open", "visit"] },
    { category: "define", keywords: ["what is", "define"] },
  ];
...
function handleSendMessage() {
  ...
  // Render chip quickly after send to meet responsiveness goals
  setTimeout(() => renderChip(category), 0);
  messageInput.value = "";
}
