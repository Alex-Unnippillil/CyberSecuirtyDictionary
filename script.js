...
const favoritesBadge = document.getElementById("favorites-new-badge");
...
if (favoritesBadge && !sessionStorage.getItem("favoritesBadgeSeen")) {
  favoritesBadge.hidden = false;
  sessionStorage.setItem("favoritesBadgeSeen", "true");
}
