...
let termsData = { terms: [] };
const layoutStore = { readerMode: false, scrollPosition: 0 };
...
function toggleReaderMode() {
  layoutStore.readerMode = !layoutStore.readerMode;
  if (layoutStore.readerMode) {
    layoutStore.scrollPosition = window.scrollY;
    document.body.classList.add("reader-mode");
    window.scrollTo({ top: 0 });
  } else {
    document.body.classList.remove("reader-mode");
    window.scrollTo({ top: layoutStore.scrollPosition });
  }
}
