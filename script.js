...
function applyPointerClass(e) {
  document.body.classList.toggle("coarse-pointer", e.matches);
  document.body.classList.toggle("fine-pointer", !e.matches);
}
applyPointerClass(pointerQuery);
pointerQuery.addEventListener("change", applyPointerClass);
