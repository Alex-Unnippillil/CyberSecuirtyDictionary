...
function displayDefinition(term) {
  ...
  definitionContainer.innerHTML = `
    ...
    <p>${term.definition}</p>`;
  const usBtn = definitionContainer.querySelector(
    '.pronunciation-button[data-lang="en-US"]',
  );
  const ukBtn = definitionContainer.querySelector(
    '.pronunciation-button[data-lang="en-GB"]',
  );
  usBtn.addEventListener("click", (e) => {
    e.stopPropagation();
    playPronunciation(term.term, "en-US");
  });
  ukBtn.addEventListener("click", (e) => {
    e.stopPropagation();
    playPronunciation(term.term, "en-GB");
  });
...
function playPronunciation(text, lang) {
